        ...
        {user ? (
          <div className="flex items-center gap-2 sm:gap-4 cursor-pointer">
            ...
            className="flex items-center gap-2 bg-purple-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700">
              ...
              <p className="text-sm sm:text-xs font-md text-gray-700">Credit: {credit}</p>
            </button>
            <p className="max-sm:hidden text-gray-700 pl-4">Hi! {user.user}</p>
          ...
          <div className="flex items-center gap-2 sm:gap-5">
            ...
            <button onClick={() => setShowLogin(true)}
             className="bg-[#2E073F] text-white font-bold px-7 py-2 sm:px-10 text-sm border-2 border-white rounded-full  hover:scale-105 transition-all duration-700 ">
              Register
            </button>
          </div>
        )}
